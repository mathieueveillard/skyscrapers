...
export const dangerouslyGenerateAllPossibleCandidates = ({ dimension }: { dimension: number }): Candidates =>
  [...new Array(dimension)].map((_, i) => memoizedGenerateCandidates({ dimension })({ sight: i + 1 })).flat();
